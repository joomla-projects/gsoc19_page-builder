...
<script>
  ...
  export default {
    ...
    watch: {
      ...
      backgroundcolor_converter(payload) {
        this.modifyStyle({"background-color": payload})
      }
    },
    data() {
      return {
    ...
    methods: {
      ...
      loadStyles() {
        if (this.elementSelected.type === 'column') {
          if (this.elementSelected.style['background-color']) {
            this.element_style['backgroundcolor'] = this.hexToHSL(this.elementSelected.style['background-color'])
          } else {
            this.element_style['backgroundcolor'] = this.hexToHSL("#000000")
          }

          if (this.elementSelected.style['font-color']) {
            this.element_style['fontcolor'] = this.hexToHSL(this.elementSelected.style['font-color'])
          } else {
            this.element_style['fontcolor'] = this.hexToHSL("#000000")
          }
          if (this.elementSelected.style['link-color']) {
            this.element_style['linkcolor'] = this.hexToHSL(this.elementSelected.style['link-color'])
          } else {
